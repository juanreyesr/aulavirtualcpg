...
export default function Hero() {
  return (
    <section className="relative mt-6 rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-r from-black/70 via-black/30 to-black/60">
      <div className="absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_20%_20%,rgba(11,59,115,0.55),transparent_45%),radial-gradient(circle_at_80%_0%,rgba(0,160,198,0.30),transparent_50%)]" />
      <div className="relative p-8 md:p-10">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="#recientes" className="px-4 py-2 rounded-full bg-cpgBlue hover:opacity-90 text-sm">
            Ver recién añadidos
          </Link>
